...
Namespace HorasMedias
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2556.0"),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="HorasMediasSoap", [Namespace]:="http://tempuri.org/")>  _
    Partial Public Class HorasMedias
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.WebApplication7.My.MySettings.Default.WebApplication7_HorasMedias_HorasMedias
        ...
        Public Function media(ByVal Asig As String) As String
            Dim results() As Object = Me.Invoke("media", New Object() {Asig})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub mediaAsync(ByVal Asig As String)
            Me.mediaAsync(Asig, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub mediaAsync(ByVal Asig As String, ByVal userState As Object)
            If (Me.mediaOperationCompleted Is Nothing) Then
                Me.mediaOperationCompleted = AddressOf Me.OnmediaOperationCompleted
            End If
            Me.InvokeAsync("media", New Object() {Asig}, Me.mediaOperationCompleted, userState)
        End Sub
